...
class RegForm extends React.Component {
    ...
    renderStep0() {
        return (<View style={style.fields}>
        ...
        return (<View style={style.fields}>
            <Animated.View style={[style.fieldWrapper, { left: this.state.field1Left }]}>
                <TextInput
                    ...
                    style={style.input} placeholder={'Create'}></TextInput>
            </Animated.View>
            <Animated.View style={[style.fieldWrapper, { left: this.state.field2Left }]}>
                <TextInput
                    secureTextEntry={true}
                    ...
                    returnKeyType="go"
                    onSubmitEditing={() => { { this.goToStep(this.state.step + 1) } }}
                    style={style.input} placeholder={'Confirm'}></TextInput>
            </Animated.View>
        </View>)
    }
    renderSelectSource() {
        return (<View style={style.selection}>
        ...
        return (
            <View style={style.pictureForm}>
                ...
                <TouchableOpacity onPress={() => {
                    ...
                    <Text style={style.buttonNextTxt}></Text>
