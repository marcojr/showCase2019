...
import {    View, Text, 
            ...
            ScrollView, Dimensions, Linking, AsyncStorage} from 'react-native'
            ...
            <View style={style.container}>
                <View style={style.linearGradient}>
                    <View style={style.scvWrapper}>
                        <ScrollView style={style.scv} horizontal={true}
                                    decelerationRate={0}
                            ...
                            <View style={[style.page, {backgroundColor: '#2196f3'}]}>
                                <View style={style.imgWrapper}>
                                    <Image source={require('../../assets/mr_icon.png')}
                            ...
                            <View style={[style.page, {backgroundColor: '#ff5722'}]}>
                                ...
                                <View style={style.descWrapper}>
                                    ...
                                    <Text style={[style.desc, { color: 'white'}]}>at <Text onPress={() => { 
                                        Linking.openURL('https://www.marcojr.com.br/showCase2019')
                                    }} style={style.hyperlink}>https://www.marcojr.com.br/showCase2019</Text></Text>
                                </View>
                                {this.renderDiscover()}
                            </View>
                        </ScrollView>
